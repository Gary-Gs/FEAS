        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <table border="1" cellpadding="0" cellspacing="0" width="100%">
					...
					<?php foreach ($rsAllocation

					as $row_rsAllocation) { ?>
                    <tr <?php if ($row_rsAllocation['clash'] == "1") echo 'class="clash_tr"'; ?> >
                        <td>
                            <a href="allocation_edit.php?project=<?php echo $row_rsAllocation['project_id']; ?>" <?php if ($row_rsAllocation['clash'] == "1") echo 'class="clash_td"'; ?> ><?php echo $row_rsAllocation['project_id']; ?>
                        </td>
