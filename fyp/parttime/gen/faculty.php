...
$query_rsProjPref 		= "SELECT * FROM " . $TABLES['staff_pref_part_time'] 	. " as sp WHERE (sp.prefer LIKE 'SCE%' OR sp.prefer LIKE 'SCSE%') AND archive=0 ORDER BY sp.staff_id ASC";
$query_rsAreaPref 		= "SELECT * FROM " . $TABLES['staff_pref_part_time'] 	. " as sp INNER JOIN ". $TABLES['interest_area'] ." as ia ON sp.prefer= ia.key AND archive=0 ";
try
{
...
<!-- InstanceBegin template="/Templates/fyp.dwt.php" codeOutsideHTMLIsLocked="false" -->
...
<body>
    ...
    <div id="wrapper">
		...
		<div id="content">
			<h1>Faculty List for Part Time Projects</h1>
			<?php if (isset ($_REQUEST['validate']) || isset ($_REQUEST['csrf'])) {
