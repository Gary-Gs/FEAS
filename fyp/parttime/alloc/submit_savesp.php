...
<?php
	...
	if(isset($_REQUEST['start_date']) && isset($_REQUEST['end_date'])) {
		...
		if ($start_dt > $end_dt ) {
			...
			$stmt = $conn_db_ntu->prepare("UPDATE ". $TABLES['allocation_settings_others'] . " SET pref_start= ? WHERE type= 'PT'");
			...
			$stmt = $conn_db_ntu->prepare("UPDATE ". $TABLES['allocation_settings_others'] . " SET pref_end= ? WHERE type= 'PT'");
